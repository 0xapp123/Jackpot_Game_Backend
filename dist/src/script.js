            ...
            if (txInfo !== undefined) {
                ...
                switch (tp) {
                    case 'PlayGame':
                        ...
                        break;
                    case 'EnterGame':
                        yield (0, db_1.enterGame)(txInfo.gamePool, io);
                        break;
                    case 'ClaimReward':
                        break;
                }
